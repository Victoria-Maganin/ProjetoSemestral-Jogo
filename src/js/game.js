...
if (window.localStorage.PlayerOne != undefined && window.localStorage.PlayerTwo != undefined) {
    ...
    var playerSettingOne = 'Chen'
    var playerSettingTwo = 'El'
}
settings.forEach(e => {
...
const keys = { // THIRD TASK  // - não da para ir para direita enquanto vc vai para a esquerda pq ele esta -1 - para resolver o ploblema: mais os if abaixo
    a: {
        pressed: false
    },
    d: {
